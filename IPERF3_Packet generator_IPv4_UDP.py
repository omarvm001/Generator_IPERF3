...
def rechercher_CS7_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0xE0")
    print(test2)
    # =========================================
    print('SEND OK')
...
def rechercher_CS6_boutton():
    ...
    test2 = os.system("iperf3 -c "+str(chaine) +" --udp -p 5003 -S 0xC0")
    print(test2)
    # =========================================
    print('SEND OK')
...
def rechercher_CS5_boutton():
    ...
    test2 = os.system("iperf3 -c "+str(chaine) +" --udp -p 5003 -S 0xA0")
    print(test2)
...
def rechercher_CS4_boutton():
    ...
    test2 = os.system("iperf3 -c "+str(chaine) +" --udp -p 5003 -S 0x80")
    print(test2)
...
def rechercher_CS3_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x60")
    print(test2)
    # =========================================
    print('SEND OK')
...
def rechercher_CS2_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x40")
    print(test2)
...
def rechercher_CS1_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x20")
    print(test2)
...
def rechercher_BE_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x00")
    print(test2)
...
def rechercher_EF_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0xB8")
    print(test2)
...
def rechercher_AF31_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x68")
    print(test2)
...
def rechercher_AF32_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x70")
    print(test2)
...
def rechercher_AF33_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x78")
    print(test2)
...
def rechercher_AF11_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x28")
    print(test2)
...
def rechercher_AF12_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x30")
    print(test2)
...
def rechercher_AF13_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x38")
    print(test2)
...
def rechercher_AF21_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x48")
    print(test2)
...
def rechercher_AF22_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x50")
    print(test2)
...
def rechercher_AF23_boutton():
    ...
    test2 = os.system("iperf3 -c " + str(chaine) + " --udp -p 5003 -S 0x58")
    print(test2)

...
def rechercher_CS7_boutton():
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0xE0")
    # CS7
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c " + str(chaine) + " --udp -p 5003 -S 0xE0")
    print(test2)
    # =========================================
    print('SEND OK')
...
def rechercher_CS6_boutton():
    ...
    test2 = os.system("iperf3 -6 -c "+str(chaine) +" --udp -p5003 -S 0xC0")
    print(test2)
    # =========================================
    print('SEND OK')
...
def rechercher_CS5_boutton():
    # CS5
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0xA0")
    # CS5
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c"+str(chaine) +" --udp -p5003 -S 0xA0")
    print(test2)
...
def rechercher_CS4_boutton():
    # CS4
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x80")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c"+str(chaine) +" --udp -p5003 -S 0x80")
    print(test2)
...
def rechercher_CS3_boutton():
    # CS3
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x60")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p 5003 -S 0x60")
    print(test2)
    # =========================================
    print('SEND OK')
...
def rechercher_CS2_boutton():
    # CS2
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x40")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p 5003 -S 0x40")
    print(test2)
...
def rechercher_CS1_boutton():
    # CS1
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x20")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x20")
    print(test2)
...
def rechercher_BE_boutton():
    # BE
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x00")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x00")
    print(test2)
...
def rechercher_EF_boutton():
    # EF
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0xB8")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0xB8")
    print(test2)
...
def rechercher_AF31_boutton():
    # AF31
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x68")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x68")
    print(test2)
...
def rechercher_AF32_boutton():
    # AF32
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x70")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x70")
    print(test2)
...
def rechercher_AF33_boutton():
    # AF33
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x78")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x78")
    print(test2)
...
def rechercher_AF11_boutton():
    # AF11
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x28")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x28")
    print(test2)
...
def rechercher_AF12_boutton():
    # AF12
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x30")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x30")
    print(test2)
...
def rechercher_AF13_boutton():
    # AF13
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x38")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x38")
    print(test2)
...
def rechercher_AF21_boutton():
    # AF21
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x48")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x48")
    print(test2)
...
def rechercher_AF22_boutton():
    # AF22
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x50")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x50")
    print(test2)
...
def rechercher_AF23_boutton():
    # AF23
    #test2 = os.system("iperf3 -6 -c176.143.171.36 --udp -p5003 -S 0x58")
    chaine = time_entry.get()
    time_entry.get()

    test2 = os.system("iperf3 -6 -c" + str(chaine) + " --udp -p5003 -S 0x58")
    print(test2)
